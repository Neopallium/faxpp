...
start_enum_state(DEFAULT_ELEMENT_CONTENT_STATE);
  ...
  while(1) {
    ...
    case '<':
      ...
      report_token(CHARACTERS_TOKEN, env);
      next_char(env);
      change_enum_state(env, DEFAULT_ELEMENT_CONTENT_MARKUP_STATE);
      return NO_ERROR;
    case '&':
      store_state(env);
    ...
    case ']':
      change_enum_state(env, DEFAULT_ELEMENT_CONTENT_RSQUARE_STATE1);
      next_char(env);
      goto_enum_state(DEFAULT_ELEMENT_CONTENT_RSQUARE_STATE1);
    LINE_ENDINGS
      break;
    default:
...
start_enum_state(UTF8_ELEMENT_CONTENT_STATE);
  ...
  while(1) {
    ...
    case '<':
      ...
      report_token(CHARACTERS_TOKEN, env);
      next_char(env);
      change_enum_state(env, UTF8_ELEMENT_CONTENT_MARKUP_STATE);
      return NO_ERROR;
    case '&':
      store_state(env);
      env->state = reference_state;
      ...
      goto NEXT_CHAR_TOK_START_RETURN;
    case ']':
      change_enum_state(env, UTF8_ELEMENT_CONTENT_RSQUARE_STATE1);
      next_char(env);
      goto_enum_state(UTF8_ELEMENT_CONTENT_RSQUARE_STATE1);
    LINE_ENDINGS
      break;
...
start_enum_state(UTF16_ELEMENT_CONTENT_STATE);
  ...
  while(1) {
    ...
    case '<':
      ...
      report_token(CHARACTERS_TOKEN, env);
      next_char(env);
      change_enum_state(env, UTF16_ELEMENT_CONTENT_MARKUP_STATE);
      return NO_ERROR;
    case '&':
      store_state(env);
      env->state = reference_state;
      ...
      goto NEXT_CHAR_TOK_START_RETURN;
    case ']':
      change_enum_state(env, UTF16_ELEMENT_CONTENT_RSQUARE_STATE1);
      next_char(env);
      goto_enum_state(UTF16_ELEMENT_CONTENT_RSQUARE_STATE1);
    LINE_ENDINGS
      break;
    default:
